    ...
    return (
        <Fragment>
            <Table size="small">
                ...
                <TableBody>
                    { teamMembers.map((member, id) => <MemberCard key={id} memberData={member} />) }
                </TableBody>
            </Table>
            ...
            <Fab className={ classes.addMemberIcon } onClick={ ()=>setAddMemberDialog(true) } 
...
const mapDispatchToProps = {
    getAllMembers, setAddMemberDialog
};
